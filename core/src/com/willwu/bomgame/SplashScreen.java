...
public class SplashScreen implements Screen {
	...
	public SplashScreen(BomGame game) {
		this.game = game;
	}

	@Override
	public void show() {
		sprite = new Sprite(AssetLoader.bombTexture3);
	...
	private void setupTween() {
		...
		Tween.to(sprite, SpriteAccessor.ALPHA, .8f).target(1).ease(TweenEquations.easeInOutQuad).repeatYoyo(1, .4f).setCallback(cb)
